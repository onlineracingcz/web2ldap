...
from w2lapp.schema.syntaxes import DirectoryString,Integer,OctetString, \
...
from w2lapp.schema.plugins.x509 import Certificate,CertificateList
...
class OctetStringGUID(OctetString):
  ...
  def displayValue(self,valueindex=0,commandbutton=0):
    if self.attrType==u'GUID':
      ...
      return w2lapp.cnf.misc.command_link_separator.join((
        self._guid2assoc_c1(self.attrValue),
