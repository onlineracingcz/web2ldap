# -*- coding: utf-8 -*-
"""
w2lapp.monitor: Display (SSL) connection data
...
from w2lapp.session import session,cleanUpThread
...
def w2l_Monitor(outf,command,form,env):
  ...
  w2lapp.gui.TopSection(
    ...
    w2lapp.gui.EntryMainMenu(form,env),
    [],
  )
  ...
  outf.write("""
    ...
    """.format(
      ...
      text_startuptime=strftimeiso8601(time.gmtime(w2lapp.core.startUpTime)),
