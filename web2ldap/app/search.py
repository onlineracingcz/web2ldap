...
class PrintableHTMLWriter(web2ldap.ldaputil.async.List):
  ...
  def processResults(self,ignoreResultsNumber=0,processResultsCount=0,timeout=-1):
    ...
    web2ldap.app.gui.TopSection(self._sid,self._outf,'search',self._form,self._ls,self._dn,'Printable Search Results',[])
    self._outf.write("""
<table
...
def w2l_Search(sid,outf,command,form,ls,dn,connLDAPUrl):
  ...
  scope,filterstr = connLDAPUrl.scope,web2ldap.app.core.str2unicode(connLDAPUrl.filterstr,form.accept_charset)
