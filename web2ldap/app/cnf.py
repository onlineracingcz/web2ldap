...
import web2ldapcnf,web2ldapcnf.hosts,web2ldapcnf.misc,web2ldapcnf.standalone,web2ldapcnf.countries
from web2ldapcnf import misc,hosts,standalone,countries
