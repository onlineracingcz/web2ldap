...
class InputFormEntry(web2ldap.app.read.DisplayEntry):
  ...
  def __init__(self,sid,form,command,ls,dn,schema,entry,writeable_attr_oids,existing_object_classes=None,invalid_attrs=None):
    ...
    web2ldap.app.read.DisplayEntry.__init__(self,sid,form,ls,dn,schema,entry,'fieldSep',False)
...
def SupentryDisplayString(
  ...
  inputform_supentrytemplate = web2ldap.app.cnf.GetParam(ls,'inputform_supentrytemplate',{})
...
def ObjectClassForm(
    ...
    if existing_object_classes and structural_object_class:
      ...
      if dit_content_rule!=None:
        ...
        dit_content_rule_html = '%s<br>DIT content rule:<br>%s' % (
          ...
          web2ldap.app.gui.SchemaElementName(sid,form,dn,sub_schema,dit_content_rule.names[0],ldap0.schema.models.DITContentRule)
        )
  ...
  def LDIFTemplateField(ls,form,parent_dn):
    all_structural_oc,all_abstract_oc,all_auxiliary_oc = web2ldap.app.schema.object_class_categories(sub_schema,all_oc)
    addform_entry_templates_keys = web2ldap.app.cnf.GetParam(ls,'addform_entry_templates',{}).keys()
    addform_parent_attrs = web2ldap.app.cnf.GetParam(ls,'addform_parent_attrs',[])
