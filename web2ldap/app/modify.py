...
import ldap0,ldap0.ldif,ldap0.schema,ldaputil.schema, \
       ldapsession,web2ldap.app.core,web2ldap.app.cnf,web2ldap.app.gui,web2ldap.app.addmodifyform,web2ldap.app.add,web2ldap.app.schema
...
def GetEntryfromInputForm(form,ls,dn,sub_schema):
  ...
  try:
    ...
    raise web2ldap.app.core.ErrorExit(u'LDIF parsing error: %s' % (form.utf2display(unicode(e))))
  else:
    if in_ldif:
...
def w2l_Modify(sid,outf,command,form,ls,dn):
  ...
  new_entry,invalid_attrs = web2ldap.app.modify.GetEntryfromInputForm(form,ls,dn,sub_schema)
  ...
  ignore_attr_types = ldaputil.schema.SchemaElementOIDSet(sub_schema,AttributeType,web2ldap.app.add.ADD_IGNORE_ATTR_TYPES)
